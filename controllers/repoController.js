...
async function createRepository(req, res) {
  ...
  try {
    ...
    // 🔹 Only validate ObjectId if your user IDs are actually ObjectIds
    if (owner && mongoose.Types.ObjectId.isValid(owner) === false) {
    ...
    console.error("Error during repository creation:", err); // full error, not just message
